...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> _requestPasswordReset() async {
    ...
    final response = await http.post(
      Uri.parse('${ApiConstants.baseUrl}/api/college/forgotDepartmentpassword'),
      body: jsonEncode({'faculty_email': email}),
  ...
  Future<void> _updatePassword() async {
    ...
    final response = await http.put(
      Uri.parse('${ApiConstants.baseUrl}/api/college/updateDepartmentPassword'),
      body: jsonEncode({
        'faculty_email': email,
